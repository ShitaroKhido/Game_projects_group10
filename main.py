...
if __name__ == "__main__":
    ...
    main_character = Character(root, main_canvas, character_img, 100,100)

    virus_img = PhotoImage(file=VIRUS_IMG_LOCATION)
    virus = Virus(root,main_canvas, virus_img, 200,200)
    virus._movement()
    virus2 = Virus(root,main_canvas, virus_img, 300,400)
    virus2._movement()
    virus3 = Virus(root,main_canvas, virus_img, 200,500)
    virus3._movement()
